...
!arguments['network'] ? dotenv.config() : (network = arguments['network'], dotenv.config({
	'path': './.env.' + network
}));
...
CONSTANTS = {
	'ROUTER_ABI': router_data[network]['ABI'],
	'ROUTER_ADDRESS': router_data[network]['ADDRESS'],
	'FACTORY_ABI': factory_data[network]['ABI'],
	'FACTORY_ADDRESS': factory_data[network]['ADDRESS'],
